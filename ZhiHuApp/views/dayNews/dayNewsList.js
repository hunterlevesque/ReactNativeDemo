...
import DayNewsItem from './dayNewsItem';
...
class DayNewsList extends Component {
	constructor(props) {
		super(props);
	...
	render() {
		return (
            ...
            <ListView
                ...
                renderRow={(rowData) => <DayNewsItem row={rowData}
	...
	getData() {
		...
		var that = this;
		var baseURL = 'http://news-at.zhihu.com/api/4/theme/11';
		//开启loading
		this.setState({
			show: false
		});
